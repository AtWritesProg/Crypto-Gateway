...
contract MerchantRegistry is IMerchantRegistry, Ownable, Pausable {
    ...
    */
     ...
     */
    function getActiveMerchants(uint256 offset, uint256 limit) 
        external 
        view 
     ...
     */
    function searchMerchantsByName(string calldata searchTerm) 
        external 
        view 
        returns (Merchant[] memory) 
    {
    ...
    function getRegistryStats() 
        external 
        view 
        returns (uint256 total, uint256 active, uint256 inactive) 
    {
