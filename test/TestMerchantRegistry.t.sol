...
contract TestMerchantRegistry is Test {
    ...
    function testCannotRegisterDuplicateMerchant() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                MerchantRegistry.MerchantAlreadyExists.selector,
                merchant1
            )
        );
    ...
    function testCannotRegisterWithTooLongBusinessName() public {
        ...
        string memory longName = "This is a very long business name that exceeds the maximum allowed length of 100 characters for testing purposes and should be rejected";
    ...
    function testCannotRegisterWithTooLongEmail() public {
        ...
        string memory longEmail = "okthisisaverylongemailaddressthatexceedsthemaximumallowedlengthof100charactersfortestingpurposes@example.com";
    ...
    function testCannotDeactivateNonexistentMerchant() public {
        vm.expectRevert(
            abi.encodeWithSelector(
                MerchantRegistry.MerchantNotFound.selector,
                nonMerchant
            )
        );
    ...
    function testUpdateMerchantStats() public {
        ...
        (uint256 totalPayments, uint256 totalVolume, uint256 registeredAt) = 
            registry.getMerchantStats(merchant1);
    ...
    function testGetActiveMerchantsPagination() public {
        ...
        IMerchantRegistry.Merchant[] memory activeMerchants = 
            registry.getActiveMerchants(0, 10);
        ...
        IMerchantRegistry.Merchant[] memory activePage1 = 
            registry.getActiveMerchants(0, 2);
        assertEq(activePage1.length, 2);
        
        IMerchantRegistry.Merchant[] memory activePage2 = 
            registry.getActiveMerchants(2, 2);
    ...
    function testSearchMerchantsByName() public {
        ...
        // Search for "Coffee"
        IMerchantRegistry.Merchant[] memory coffeeShops = 
            registry.searchMerchantsByName("Coffee");
        ...
        IMerchantRegistry.Merchant[] memory noResults = 
            registry.searchMerchantsByName("Pizza");
        assertEq(noResults.length, 0);
        
        // Search with empty term
        IMerchantRegistry.Merchant[] memory emptySearch = 
            registry.searchMerchantsByName("");
